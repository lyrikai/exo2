...
ActiveRecord::Schema.define(version: 2022_10_27_130018) do
  ...
  create_table "dogsitters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_id"], name: "index_dogsitters_on_country_id"
  end
  ...
  create_table "strolls", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_id"], name: "index_strolls_on_country_id"
